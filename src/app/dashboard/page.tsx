    ...
    <>
      <div className="flex items-center justify-between">
       ...
       <div className="grid gap-4 md:gap-8 lg:grid-cols-3 xl:grid-cols-3 lg:[grid-template-areas:'summary_actions_security''transactions_transactions_monitor']">
        ...
        <div className="lg:[grid-area:actions] flex flex-col gap-4">
            <Dialog open={isTransferOpen} onOpenChange={setIsTransferOpen}>
                <DialogTrigger asChild>
                    <Button className="w-full flex items-center justify-center h-full text-base py-6">
            ...
            <Dialog open={isPayBillOpen} onOpenChange={setIsPayBillOpen}>
                <DialogTrigger asChild>
                     <Button variant="secondary" className="w-full flex items-center justify-center h-full text-base py-6">
